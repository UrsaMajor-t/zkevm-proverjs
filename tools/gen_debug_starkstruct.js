...
async function main() {
    ...
    // Check if pilFile and starkstructFile exist
    const pilFileExists = fs.existsSync(pilFile);
    const starkstructFileExists = fs.existsSync(starkstructFile);

    console.log(`pilFile exists: ${pilFileExists}, pilFile: ${pilFile}`);
    console.log(`starkstructFile exists: ${starkstructFileExists}, starkstructFile: ${starkstructFile}`);
